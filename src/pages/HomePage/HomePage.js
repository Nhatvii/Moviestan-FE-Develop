...
function HomePage(props) {
  ...
  useEffect(() => {
    ...
    async function firstTimeCall() {
      await props.callToGetListFilm();
      await callApiHeThongRap();
      setIsLoading(false);
    }
    firstTimeCall();
  }, []);
  ...
  }, [listRapTheoHeThongRap, cumRap.maHeThongRap]);
    ...
    <div className="container">
      {isLoading ? (
        ...
        <div>
          ...
          <NavBar />
          <Element name="list-film" className="element">
          ...
          <Element name="list-theatre" className="element">
